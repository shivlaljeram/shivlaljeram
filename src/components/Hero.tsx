...
export default function Hero() {
  ...
  return (
    <section className="relative pt-28 sm:pt-32 pb-20 sm:pb-28 bg-bg-primary overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="mt-10 flex items-center justify-center gap-6 sm:gap-10 animate-fade-up" style={{ animationDelay: '0.3s' }}>
            <div className="text-center">
              <div className="text-2xl sm:text-3xl font-bold text-accent-light font-serif">18+</div>
              <div className="text-xs text-text-dim mt-1">Premium Variants</div>
            </div>
